        ...
        <div class="w-full max-w-2xl p-4 bg-white shadow-2xl dark:bg-gray-900 sm:p-10 sm:rounded-3xl">
            <div class="text-center">
                ...
                <p class="mt-6 text-xl text-blue-600 dark:text-blue-400">
                    Your order tracking <span class="font-bold text-indigo-700 dark:text-indigo-400">order tracking code</span> will be listed
                    shortly and you will be to track it   <a class="font-medium text-indigo-600 dark:text-indigo-400 underline">
                        here
                    </a>
                </p>
