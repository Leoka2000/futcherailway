            ...
            <swiper-slide class="mb-10">
                ...
                <div
                    ...
                    <div class="relative w-full h-auto rounded-md">
                        <img src="{{ asset('storage/' . ($firstImage ?? 'default.jpg')) }}" alt="{{ $product->name }}"
                            class="w-full transition-opacity duration-300 rounded-md h-72" loading="lazy"
                        ...
                        <!-- Placeholder -->
                        <div class="absolute top-0 left-0 flex items-center justify-center w-full h-full transition-opacity duration-300 bg-white rounded-t-md dark:bg-gray-800"
                    ...
                    <div class="flex flex-col flex-grow p-5">
                        ...
                        <a>
                            <h5
                                class="mb-2 text-sm font-bold tracking-tight text-gray-900 truncate xl:text-base dark:text-white">
                        ...
                        <div class="flex items-center gap-1 mb-2">
                            <p class="text-sm">
                                ...
                                <span class="font-semibold text-green-500 dark:text-green-600">R$ 15,24</span>
                            </p>
                        </div>
                        ...
                        <a href="{{ route('components.shopping_cart_component_index') }}" class="relative"
                            x-data="{ loading: false }" @click.prevent="
                             ...
                             ">
                            <span x-show="!loading">
                                <x-mary-button icon="o-shopping-bag" label="Ver mais" class="w-full btn-sm lg:btn" />
                            </span>
                            <span x-show="loading">
