<x-guest-layout>
    ...
    <x-authentication-card>
        ...
        <span class="text-sm inline-block mb-3 dark:text-gray-300 text-gray-900">Se já tem uma conta, <a href="{{route('register')}}" class="underline cursor-pointer text-yellow-600 dark:text-yellow-400">faça login aqui</a></span>

        <x-validation-errors class="mb-4" />

        <form method="POST" action="{{ route('register') }}" onsubmit="setLoadingState()">
            @csrf
