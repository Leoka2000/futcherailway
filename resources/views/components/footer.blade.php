...
<section class="text-gray-700 dark:text-gray-300 bg-white dark:bg-inherit  body-font" {!! $attributes ?? '' !!}>
    <div class="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
        ...
        <span class="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
            ...
            <a href="https://www.instagram.com/futche.sports/" target="_blank" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
            ...
            <a href="https://github.com/Leoka2000/futcheloja" target="_blank" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
