...
<body x-data="{ loading: false }" x-on:alpine:route-change-start.window="loading = true" x-init="
...
" class="font-sans antialiased relative">
    ...
    <!-- Loading Spinner -->
    <div x-show="loading" x-transition class="fixed inset-0 z-50 bg-gray-800 bg-opacity-50 flex items-center justify-center backdrop-blur-lg">
        <div role="status">
