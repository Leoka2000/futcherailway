...
<body class="relative font-sans antialiased dark:bg-gray-950 dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-gray-950 dark:text-white/50">
        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <button id="theme-toggle" class="ml-4 p-2 bg-gray-200 dark:bg-gray-700 rounded-lg">
                        Toggle Theme
                    </button>
